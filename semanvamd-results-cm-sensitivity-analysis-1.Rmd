---
title: "Semaglutide NVAMD Cohort Method Results - Sensitivity Analysis #1"
author: "Diep Tran"
date: "`r Sys.Date()`"
...
-   `301`: New user of semaglutide with prior T2DMndef

-   `313`: New user of empagliflozin with prior T2DM

-   `301`: New user of semaglutide with prior T2DM vs.\

-   `314`: New user of sitagliptin with prior T2DM

--

-   `301`: New user of semaglutide with prior T2DM\
-   `315`: New user of glipizide with prior T2DM

--

-   `301`: New user of semaglutide with prior T2DM
-   `311`: New user of dulaglutide with prior T2DM

--

-   `301`: New user of semaglutide with prior T2DM\
-   `312`: New user of exenatide with prior T2DM
...
#Update this part <- DN: Ctrl + Shift + C for turn on/off multiple comment lines

cohortIds <- c(
  "New user of semaglutide with prior T2DM and prior metformin and no insulin" = 201,
  "New user of empagliflozin with prior T2DM and prior metformin and no insulin" = 211,
  "New user of sitagliptin with prior T2DM and prior metformin and no insulin" = 212,
  "New user of glipizide with prior T2DM and prior metformin and no insulin" = 213,
  "New user of dulaglutide with prior T2DM and prior metformin and no insulin" = 214,
  "New user of exenatide with prior T2DM and prior metformin and no insulin" = 215
)
...
# cohortIds <- c(
#   "New user of semaglutide with prior T2DM" = 301,
#   "New user of dulaglutide with prior T2DM" = 311,
#   "New user of exenatide with prior T2DM" = 312,
#   "New user of empagliflozin with prior T2DM" = 313,
#   "New user of sitagliptin with prior T2DM" = 314,
#   "New user of glipizide with prior T2DM" = 315
# )
# 
# cohortIds_DT <- c(
#   301,
...
cohortCombinations <- readr::read_csv("https://raw.githubusercontent.com/ohdsi-studies/SemaglutideNvamd/main/inst/cmTcList.csv") |> 
...
# Save the results
xlsx::write.xlsx(savedResults, "semanvamd-results-cm-sensitivity-analysis-1-series2.xlsx")
# xlsx::write.xlsx(savedResults, "semanvamd-results-cm-sensitivity-analysis-1-series3.xlsx")
#saveRDS(savedResults, "semanvamd-results-cm-sensitivity-analysis-1.rds")
