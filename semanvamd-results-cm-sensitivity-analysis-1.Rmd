...
cohortIds <- c(
  "New user of semaglutide with prior T2DM and prior metformin and no insulin" = 301,
  "New user of empagliflozin with prior T2DM and prior metformin and no insulin" = 313,
  "New user of sitagliptin with prior T2DM and prior metformin and no insulin" = 314,
  "New user of glipizide with prior T2DM and prior metformin and no insulin" = 315,
  "New user of dulaglutide with prior T2DM and prior metformin and no insulin" = 311,
  "New user of exenatide with prior T2DM and prior metformin and no insulin" = 312
)
...
# Save the results
xlsx::write.xlsx(savedResults, "semanvamd-results-cm-sensitivity-analysis-1.xlsx")
