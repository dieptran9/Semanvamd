...
# Need a reference why pick the drug exposure
...
results <- aggregateResults(17706)
...
xlsx::write.xlsx(processForSaving(results), "study-diagnostics_cm_pdr.xlsx")

```

## Treatment-requiring Diabetic Retinopathy or Macular Edema including vitrectomy

```{r specific_pdr, echo=FALSE}

results <- aggregateResults(17788)
results |> DT::datatable(options = list(pageLength = 20))
...
xlsx::write.xlsx(processForSaving(results), "study-diagnostics_cm_tdrmev.xlsx")
