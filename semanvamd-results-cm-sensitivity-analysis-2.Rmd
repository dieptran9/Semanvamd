---
title: "Semaglutide NVAMD Cohort Method Results - Sensitivity Analysis #2"
author: "Diep Tran"
date: "`r Sys.Date()`"
...
-   `401`: New user of semaglutide as 2nd line prior T2DM and metformin Dec2017-Jan2020 vs.
-   `411`: New user of empagliflozin as 2nd line prior T2DM and metformin Dec2017-Jan2020

--

-   `402`: New user of semaglutide as 2nd line prior T2DM and metformin Feb2020-June2021 vs.
-   `412`: New user of empagliflozin as 2nd line prior T2DM and metformin Feb2020-June2021

--

-   `403`: New user of semaglutide as 2nd line prior T2DM and metformin July2021-Dec2024 vs.
-   `413`: New user of empagliflozin as 2nd line prior T2DM and metformin July2021-Dec2024
...
cohortIds <- c(
    "Semaglutide 2nd-line tx w/ prior T2DM Dec2017-Jan2020" = 401,
    "Semaglutide 2nd-line tx w/ prior T2DM Feb2020-Jun2021" = 402,
    "Semaglutide 2nd-line tx w/ prior T2DM Jul2021-Dec2024" = 403,
    "Empagliflozin 2nd-line tx w/ prior T2DM Dec2017-Jan2020" = 411,
    "Empagliflozin 2nd-line tx w/ prior T2DM Feb2020-Jun2021" = 412,
    "Empagliflozin 2nd-line tx w/ prior T2DM Jul2021-Dec2024" = 413
)
...
SELECT \* FROM semanvamd.cm_diagnostics_summary WHERE balance_diagnostic = 'PASS' AND shared_balance_diagnostic = 'PASS' AND equipoise_diagnostic = 'PASS' AND mdrr_diagnostic = 'PASS' AND ease_diagnostic = 'PASS' AND outcome_id IN (1, 2) AND ( (target_id = 401 AND comparator_id = 411) OR (target_id = 402 AND comparator_id = 412) OR (target_id = 403 AND comparator_id = 413) );
...
# Save the results
xlsx::write.xlsx(savedResults, "semanvamd-results-cm-sensitivity-analysis-2.xlsx")
saveRDS(savedResults, "semanvamd-results-cm-sensitivity-analysis-2.rds")
